...
namespace Tempest 
{
    ...
    public:
        ...
        static void drawText(const glm::vec2& position, const glm::vec2& size, const stbtt_aligned_quad& coords, const ref<Texture2D> texture, float tileFactor = 1.f, const glm::vec4& tint = glm::vec4(1.f));
        static void drawText(const glm::vec3& position, const glm::vec2& size, const stbtt_aligned_quad& coords, const ref<Texture2D> texture, float tileFactor = 1.f, const glm::vec4& tint = glm::vec4(1.f));
